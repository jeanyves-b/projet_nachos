...
echo
echo -e "Appuyer sur [Entrée] pour lancer les tests de l'\033[31;1métape 2\033[0m.."; read;
cd etape2
./lancer.sh
cd ..
echo
echo -e "Appuyer sur [Entrée] pour passer à l'\033[31;1métape 3\033[0m.."; read;
...
echo
echo -e "Appuyer sur [Entrée] pour lancer les tests de l'\033[31;1métape 3\033[0m.."; read;
cd etape3
./lancer.sh
cd ..
echo
echo -e "Appuyer sur [Entrée] pour passer à l'\033[31;1métape 4\033[0m.."; read;
...
echo
echo -e "Appuyer sur [Entrée] pour lancer les tests de l'\033[31;1métape 4\033[0m.."; read;
cd etape4
./lancer.sh
cd ..
echo

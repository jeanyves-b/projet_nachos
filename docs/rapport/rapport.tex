...
\section{Organisation du travail}
		...
		~\par{Sur les quatre premières étapes, le travail s'effectuait par équipes de deux personnes, travaillant chacune sur une partie de l'étape en parallèle, ce qui a permis une progression assez rapide.}

...
\begin{frame}{Multithreading: Attente et terminaison}
   \begin{itemize}
       ...
       \item Terminaison automatique des threads ayant terminé l'exécution de leur fonction.
   \end{itemize}
\end{frame}
...
\begin{frame}{Gestion de la mémoire: Autre fonctionnalités et problème}
    \begin{itemize}
        \item Shell
        \begin{itemize}
 			\item Attente active
...
\begin{frame}{Conclusion}
	\begin{itemize}
		...
		\begin{itemize}
			\item Nous a aidée à comprendre les fonctionalités bas niveau du système.
			\item Nous avons mieux maitriser les partie 3 et 4.
			\item docs sur l'architecture global et les liens entre les fichiers.
			\item interessant et agréable
		\end{itemize}
	\end{itemize}
\end{frame}
